!function(t) {
    ...
    function s(t, e) {
        try {
            if (e === t)
                throw new TypeError("Une promesse ne peut pas être résolue avec elle-même.");
...
try {
    ...
    !0 !== ce.defaultPrevented)
        throw new Error("N'a pas pu empêcher la valeur par défaut.")
} catch (t) {
        ...
        Object.defineProperty(n.prototype, "value", {
            get: function() {
                ...
                if (n && !this.partOfSeveralChoices) {
                    ...
                    e = t.Helpers.getInnerTextOfElement(this.el);
                return e
            },
            enumerable: !0,
            configurable: !0
...
!function(t) {
    ...
    var e = function() {
        ...
        e.prototype.onChatReponsesUpdated = function(t) {
            ...
            t.detail.currentResponse.isRobotResponse || (this.animateInFromResponseTimer = setTimeout(function() {
                e.animateElementsIn()
        ...
        e.prototype.onListChanged = function() {
            ...
            requestAnimationFrame(function() {
                t.ConversationalForm.illustrateFlow(e, "dispatch", t.ControlElementsEvents.CHANGED),
                e.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementsEvents.CHANGED))
            })
        }
        ,
        ...
        e.prototype.updateRowIndex = function(t) {
            ...
            this.tableableRows[this.rowIndex])
                for (var n = this.tableableRows[e] ? this.tableableRows[e][this.columnIndex].positionVector.centerX : 0, i = this.tableableRows[this.rowIndex], o = 1e13, s = 0; s < i.length; s++) {
                    var r = i[s];
                    o > Math.abs(n - r.positionVector.centerX) && (o = Math.abs(n - r.positionVector.centerX),
                    this.columnIndex = s)
                }
        }
        ,
        ...
        e.prototype.filterElementsFrom = function(e) {
            ...
            if (i.length > 1) {
                for (var o = [], s = 0; s < i.length; s++) {
                    ...
                    r.visible = a,
                    a && r.visible && o.push(r)
                }
                this.infoElement.innerHTML = 0 == o.length ? t.Dictionary.get("input-no-filter").split("{input-value}").join(e) : "",
                0 == o.length ? this.infoElement.classList.add("show") : this.infoElement.classList.remove("show");
                this.filterListNumberOfVisible != o.length && this.animateElementsIn(),
        ...
        e.prototype.animateElementsIn = function() {
            var t = this;
            this.elements.length > 0 && (this.resize(),
            ...
            if (this.elements && this.elements.length > 0)
                ...
                case "CheckboxButton":
                    for (var n = 0, i = [], o = 0; o < this.elements.length; o++) {
                        if (this.elements[o].checked && n++ > 1)
                            break
                    }
                    for (var o = 0; o < this.elements.length; o++) {
                        var s = this.elements[o];
                        s.checked && (n > 1 && (s.partOfSeveralChoices = !0),
                        i.push(s.value)),
                ...
                case "RadioButton":
                    for (var o = 0; o < this.elements.length; o++) {
                        ...
                        r.checked && (e.text = r.value),
                        e.controlElements.push(r)
                    }
                    break;
                case "OptionsList":
        ...
        e.prototype.buildTags = function(e) {
            ...
            this.filterListNumberOfVisible = r ? this.elements[0].elements.length : e.length,
        ...
        e.prototype.resize = function(e, n) {
            ...
            if (i && i.length > 0) {
                ...
                var c = this.el.offsetWidth
                  , u = this.listWidth > c;
                u && !r ? (this.el.classList.add("two-row"),
                this.listWidth = Math.max(c, Math.round(o[Math.floor(o.length / 2)] + 50)),
                this.list.style.width = this.listWidth + "px") : this.el.classList.add("one-row");
                ...
                u ? this.el.classList.remove("hide-nav-buttons") : this.el.classList.add("hide-nav-buttons"),
                this.elementWidth = c,
                this.listScrollController.resize(this.listWidth, this.elementWidth),
                this.el.classList.add("resized"),
                this.eventTarget.dispatchEvent(new CustomEvent(t.ControlElementsEvents.ON_RESIZE)),
                e && (this.buildTabableRows(),
                e())
            }
        }
        ,
...
!function(t) {
    var e = function() {
        ...
        e.prototype.render = function() {
            ...
            this.inputAccerlation += (this.inputAccerlationTarget - this.inputAccerlation) * (this.interacting ? Math.min(e.acceleration + .1, 1) : e.acceleration);
            ...
            this.xTarget > 0 && (this.xTarget += (0 - this.xTarget) * t.Helpers.lerp(e.acceleration, .3, .8)),
            this.xTarget < this.max && (this.xTarget += (this.max - this.xTarget) * t.Helpers.lerp(e.acceleration, .3, .8)),
            this.x += .4 * (this.xTarget - this.x);
            var i = Math.round(this.x);
            i < 0 && (this.prevButton.classList.contains("active") || this.prevButton.classList.add("active"),
            this.prevButton.classList.contains("cf-gradient") || this.prevButton.classList.add("cf-gradient")),
            0 == i && (this.prevButton.classList.contains("active") && this.prevButton.classList.remove("active"),
            this.prevButton.classList.contains("cf-gradient") && this.prevButton.classList.remove("cf-gradient")),
            i > this.max && (this.nextButton.classList.contains("active") || this.nextButton.classList.add("active"),
            this.nextButton.classList.contains("cf-gradient") || this.nextButton.classList.add("cf-gradient")),
            i <= this.max && (this.nextButton.classList.contains("active") && this.nextButton.classList.remove("active"),
...
!function(t) {
    var e = function() {
        function e(e) {
            ...
            this.eventTarget = e.eventTarget,
            this.eventTarget.addEventListener(t.FlowEvents.FLOW_UPDATE, this.flowUpdateCallback, !1),
            this.eventTarget.addEventListener(t.FlowEvents.FORM_SUBMIT, function() {
    ...
    var e = function() {
        function e(t) {
            this.data = {
                ...
                "entry-not-found": "Élément non trouvé dans le dictionnaire.",
                "awaiting-mic-permission": "En attente de la permission du microphone",
                "user-audio-reponse-invalid": "Je n'ai pas compris, réessayez.",
                "microphone-terminal-error": "Entrée audio non prise en charge",
                "input-placeholder": "Tapez votre réponse ici...",
                "group-placeholder": "Tapez pour filtrer...",
                "input-placeholder-error": "Votre saisie n'est pas correcte...",
                "input-placeholder-required": "Saisie requise...",
                "input-placeholder-file-error": "Échec du téléchargement du fichier...",
                "input-placeholder-file-size-error": "Taille du fichier trop grande...",
                "input-no-filter": "Aucun résultat trouvé pour... ‛{input-value}‛",
                "user-reponse-and": " et ",
                "user-reponse-missing": "Saisie manquante...",
                "user-reponse-missing-group": "Rien de sélectionné...",
            ...
            this.robotData = {
                ...
                input: "Veuillez écrire du texte.",
                text: "Veuillez écrire du texte.",
                textarea: "Veuillez écrire du texte.",
                checkbox: "Sélectionnez autant que vous le souhaitez.",
                name: "Quel est votre nom ?",
                email: "J'ai besoin de votre adresse e-mail.",
                password: "Veuillez fournir un mot de passe.",
                tel: "Quel est votre numéro de téléphone ?",
                radio: "J'ai besoin que vous en sélectionniez un parmi ceux-ci.",
                select: "Choisissez l'une de ces options.",
                file: "Sélectionnez un fichier à télécharger.",
                general: "General1||General2||General3.."
            },
            e.instance = this,
            this.version = t.version,
            t && t.data && (this.data = this.validateAndSetNewData(t.data, this.data)),
            t.userImage ? this.data["user-image"] = t.userImage : this.data["user-image"] = this.data["user-image"],
            t.robotImage ? this.robotData["robot-image"] = t.robotImage : this.robotData["robot-image"] = this.robotData["robot-image"],
            t && t.robotData && (this.robotData = this.validateAndSetNewData(t.robotData, this.robotData))
        }
...
!function(t) {
    ...
    var e = function() {
        function e(e) {
            if (this.domElement = e.domElement,
            ...
            "group" != this.type && t.ConversationalForm.illustrateAppFlow && (t.ConversationalForm.suppressLog || console.log("Conversational Form > Tag registered:", this.type, this)),
            this.refresh()
        }
        ...
        e.isTagValid = function(e) {
            if ("hidden" === e.getAttribute("type"))
                return !1;
            if ("submit" === e.getAttribute("type"))
                return !1;
            if ("button" == e.getAttribute("type"))
                return !1;
            if (e.style) {
        ...
        e.prototype.setTagValueAndIsValid = function(t) {
            var e = !0
              , n = t.text;
            this.domElement.hasAttribute("type") && "email" === this.domElement.getAttribute("type") && !this.pattern && n.length > 0 ? this.pattern = /^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/ : this.domElement.hasAttribute("type") && "email" === this.domElement.getAttribute("type") && this.pattern && 0 === n.length && !this.required && (this.pattern = null),
        ...
        e.prototype.findAndSetQuestions = function() {
            if (!this.questions) {
                if (this.domElement.getAttribute("cf-questions"))
                    this.questions = t.Helpers.getValuesOfBars(this.domElement.getAttribute("cf-questions")),
                    ...
                    this.questions = t.Helpers.getValuesOfBars(e.getAttribute("cf-questions")),
                    e.getAttribute("cf-input-placeholder") && (this._inputPlaceholder = e.getAttribute("cf-input-placeholder"))
                } else {
...
!function(t) {
    var e = function() {
        function e(e) {
            ...
            this._fieldset && this._fieldset.getAttribute("cf-questions") && (this.questions = t.Helpers.getValuesOfBars(this._fieldset.getAttribute("cf-questions"))),
            this._fieldset && this._fieldset.getAttribute("cf-input-placeholder") && (this._inputPlaceholder = this._fieldset.getAttribute("cf-input-placeholder")),
            t.ConversationalForm.illustrateAppFlow && (t.ConversationalForm.suppressLog || console.log("Conversational Form > TagGroup registered:", this.elements[0].type, this)),
            this.skipUserInput = !1
        }
        ...
        e.prototype.hasConditionsFor = function(t) {
            for (var e = 0; e < this.elements.length; e++) {
                if (this.elements[e].hasConditionsFor(t))
                    return !0
            }
            return !1
        }
        ...
        e.prototype.hasConditions = function() {
            for (var t = 0; t < this.elements.length; t++) {
                if (this.elements[t].hasConditions())
                    return !0
            }
            return !1
        }
            ...
            case "radio":
                ...
                if (t.controlElements)
                    for (var s = 0; s < t.controlElements.length; s++) {
                        ...
                        o.push(r),
                        a == r.referenceTag && (r.checked && (this._values.push(a.value),
                    ...
                    for (var s = 0; s < this.elements.length; s++) {
                        ...
                        -1 === l.indexOf(c) && -1 === c.indexOf(l) || (this._activeElements.push(a),
            ...
            case "checkbox":
                ...
                t.controlElements)
                    for (var s = 0; s < t.controlElements.length; s++) {
                        ...
                        r.checked && (this._values.push(a.value),
                        this._activeElements.push(a))
                    }
            ...
            t.controlElements)
                for (var i = 0; i < this.optionTags.length; i++)
                    for (var o = this.optionTags[i], s = 0; s < t.controlElements.length; s++) {
                        var r = t.controlElements[s];
                        r.referenceTag == o && (o.selected = r.selected,
                        !e && o.selected && (e = !0),
                ...
                for (var a = !1, i = 0; i < this.optionTags.length; i++) {
                    var o = this.optionTags[i]
                      ...
                      , c = t.text.toString().toLowerCase();
                    -1 === l.indexOf(c) && -1 === c.indexOf(l) || (this._values.push(o.value),
    ...
    var e = function(t) {
        ...
        Object.defineProperty(e.prototype, "checked", {
            ...
            set: function(t) {
                ...
                this.referenceTag.domElement.checked = !0) : (this.el.removeAttribute("checked"),
        ...
        n.prototype.onDomElementChange = function(e) {
            ...
            i.onloadstart = function(e) {
                ...
                if (s > n.maxFileSize) {
                    ...
                    t.ConversationalForm.illustrateFlow(n, "dispatch", t.FlowEvents.USER_INPUT_INVALID, r),
                    ...
                    var c = 1 * Number((s / Math.pow(1024, a)).toFixed(2)) + " " + l[a]
                      , u = o.name + " (" + c + ")";
                    n.el.getElementsByTagName("cf-upload-file-text")[0].innerHTML = u,
...
!function(t) {
    ...
    var e = function() {
        ...
        e.prototype.getUserMedia = function() {
            ...
            try {
                ...
                void 0 === navigator.mediaDevices.getUserMedia && (navigator.mediaDevices.getUserMedia = function(t) {
                ...
                navigator.mediaDevices.getUserMedia({
                    ...
                    e.currentStream = t,
                    t.getAudioTracks().length > 0 ? (e.hasUserMedia = !0,
                    e.setupEqualizer(),
                    e.microphoneObj.awaitingCallback || e.callInput()) : e.hasUserMedia = !1
                }).catch(function(n) {
                    e.hasUserMedia = !1,
                    e.eventTarget.dispatchEvent(new Event(t.MicrophoneBridgeEvent.TERMNIAL_ERROR))
                })
            } catch (e) {
                this.hasUserMedia = !1,
                this.eventTarget.dispatchEvent(new Event(t.MicrophoneBridgeEvent.TERMNIAL_ERROR))
            }
        }
        ,
        e.prototype.dealloc = function() {
        ...
        e.prototype.callInput = function(e) {
            ...
            this.promise = new Promise(function(t, e) {
                ...
                !n.currentTextResponse || "" == n.currentTextResponse)
                    return n.showError(t.Dictionary.get("user-audio-reponse-invalid")),
                    void n.callInput();
                n.inputErrorCount = 0,
                n.inputCurrentError = "",
                n.button.loading = !1;
                ...
                t.ConversationalForm.illustrateFlow(n, "dispatch", t.UserInputEvents.SUBMIT, i),
                n.eventTarget.dispatchEvent(new CustomEvent(t.UserInputEvents.SUBMIT,{
                    detail: i
                }))
            }).catch(function(e) {
                ...
                t.ConversationalForm.suppressLog || console.log("Conversational Form: Terminal error: ", e)) : (n.inputCurrentError != e && (n.inputErrorCount = 0,
                n.inputCurrentError = e),
                n.inputErrorCount++,
                n.inputErrorCount > 2 ? n.showError(e) : (n.eventTarget.dispatchEvent(new CustomEvent(t.MicrophoneBridgeEvent.TERMNIAL_ERROR,{
                    detail: t.Dictionary.get("microphone-terminal-error")
                })),
        ...
        e.prototype.showError = function(e) {
            ...
            t.ConversationalForm.illustrateFlow(this, "dispatch", t.FlowEvents.USER_INPUT_INVALID, n),
            this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.USER_INPUT_INVALID,{
                detail: n
            })),
            this.callInput()
        }
    ...
    var n = function() {
        ...
        return Object.defineProperty(t.prototype, "disabled", {
            set: function(t) {
                this._disabled = t,
                this.elementToScale.style.borderWidth = "0px"
            },
            enumerable: !0,
            configurable: !0
        }),
        t.prototype.onAudioProcess = function() {
            if (!this._disabled) {
                ...
                this.maxBorderWidth || (this.maxBorderWidth = .5 * this.elementToScale.offsetWidth),
                this.elementToScale.style.borderWidth = this.maxBorderWidth * s + "px"
            }
        }
        ,
        t.prototype.dealloc = function() {
...
!function(t) {
    ...
    var e = function() {
        function e(e) {
            ...
            this.eventTarget.addEventListener(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, this.onMicrophoneTerminalErrorCallback, !1)
        }
        return Object.defineProperty(e.prototype, "typing", {
            ...
            set: function(t) {
                t ? (this.el.classList.add("typing"),
                this.loading = !1,
                this.mic && this.mic.cancel()) : (this.el.classList.remove("typing"),
        ...
        ,
        e.prototype.dealloc = function() {
            this.eventTarget.removeEventListener(t.MicrophoneBridgeEvent.TERMNIAL_ERROR, this.onMicrophoneTerminalErrorCallback, !1),
...
!function(t) {
    var e = function(e) {
        function n(n) {
            var i = e.call(this, n) || this;
            return i._disabled = !1,
            i._visible = !1,
            i.onChatReponsesUpdatedCallback = i.onChatReponsesUpdated.bind(i),
            i.eventTarget.addEventListener(t.ChatListEvents.CHATLIST_UPDATED, i.onChatReponsesUpdatedCallback, !1),
        ...
        Object.defineProperty(n.prototype, "visible", {
            set: function(t) {
                var e = this;
                this._visible = t,
                !this.el.classList.contains("animate-in") && t ? setTimeout(function() {
        ...
        Object.defineProperty(n.prototype, "disabled", {
            ...
            set: function(t) {
                ...
                t ? this.el.setAttribute("disabled", "disabled") : (this.setFocusOnInput(),
        ...
        Object.defineProperty(n.prototype, "height", {
            get: function() {
                var e = 0
                  , n = 0
                  , i = this.el;
                return t.Helpers.isInternetExlorer() ? (e = i.offsetHeight,
                n = parseInt(i.currentStyle.marginTop, 10) + parseInt(i.currentStyle.marginBottom, 10),
                n *= 2) : (e = parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("height"), 10),
                n = parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("margin-top")) + parseInt(document.defaultView.getComputedStyle(i, "").getPropertyValue("margin-bottom"))),
                e + n
            },
            enumerable: !0,
            configurable: !0
        ...
        n.prototype.onChatReponsesUpdated = function(t) {
            t.detail.currentResponse.isRobotResponse || (this.visible = !0,
            this.disabled = !1,
...
!function(t) {
    var e = function(e) {
        function n(n) {
            ...
            t.ConversationalForm.animationsEnabled || i.inputElement.setAttribute("no-animations", ""),
            ...
            i.onSubmitButtonChangeStateCallback = i.onSubmitButtonChangeState.bind(i),
            i.eventTarget.addEventListener(t.UserInputSubmitButtonEvents.CHANGE, i.onSubmitButtonChangeStateCallback, !1),
            i.submitButton = new t.UserInputSubmitButton({
                eventTarget: i.eventTarget
            }),
            i.el.querySelector("div").appendChild(i.submitButton.el),
            n.microphoneInputObj && (i.microphoneObj = n.microphoneInputObj,
        ...
        Object.defineProperty(n.prototype, "disabled", {
            set: function(e) {
                ...
                t.ConversationalForm.suppressLog || console.log("option hasChanged", e),
                n && (this._disabled = e,
                e ? (this.el.setAttribute("disabled", "disabled"),
        ...
        n.prototype.reactivate = function() {
            ...
            this.microphoneObj && !this.submitButton.typing && (this.submitButton.loading = !0,
        ...
        n.prototype.inputInvalid = function(e) {
            ...
            this.disabled = !0,
            this.inputElement.setAttribute("placeholder", i.errorText || (this._currentTag ? this._currentTag.errorMessage : "")),
            clearTimeout(this.errorTimer),
            this.submitButton.loading = !1,
            this.errorTimer = setTimeout(function() {
                n.disabled = !1,
                t.ConversationalForm.suppressLog || console.log("option, disabled 1"),
                n.el.removeAttribute("error"),
                n.inputElement.value = n.inputElement.getAttribute("data-value"),
        ...
        n.prototype.checkForCorrectInputTag = function() {
            ...
            if (this.inputElement && this.inputElement.tagName !== t && (this.inputElement.removeEventListener("focus", this.onInputFocusCallback, !1),
            ...
            "INPUT" === t) {
                ...
                "password" === this.inputElement.type && e.setAttribute("autocomplete", "new-password"),
                this._currentTag.domElement.hasAttribute("autocomplete") && e.setAttribute("autocomplete", this._currentTag.domElement.getAttribute("autocomplete")),
                this._currentTag.domElement.hasAttribute("list") && e.setAttribute("list", this._currentTag.domElement.getAttribute("list")),
            ...
            this.inputElement && this.inputElement.tagName !== t && (this.inputElement.addEventListener("focus", this.onInputFocusCallback, !1),
        ...
        n.prototype.onFlowUpdate = function(n) {
            ...
            this.inputElement.setAttribute("type", o ? this._currentTag.type : "input"),
            clearTimeout(this.errorTimer),
            ...
            this._currentTag.defaultValue && (this.inputElement.value = this._currentTag.defaultValue.toString()),
            !0 === this._currentTag.skipUserInput ? this.el.classList.add("hide-input") : this.el.classList.remove("hide-input"),
            this._currentTag.rows && this._currentTag.rows > 1 && this.inputElement.setAttribute("rows", this._currentTag.rows.toString()),
            t.UserInputElement.hideUserInputOnNoneTextInput && (this.controlElements.active ? (this.el.classList.add("hide-input"),
            this.controlElements.focusFrom("bottom")) : this.el.classList.remove("hide-input")),
        ...
        n.prototype.onKeyDown = function(e) {
            (this.active || this.controlElements.focus) && (this.isControlElementsActiveAndUserInputHidden() || this.isMetaKeyPressed(e) || (e.keyCode == t.Dictionary.keyCodes.shift && (this.shiftIsDown = !0),
            !0 === this.cfReference.preventSubmitOnEnter && this.inputElement.hasAttribute("rows") && parseInt(this.inputElement.getAttribute("rows")) > 1 || e.keyCode != t.Dictionary.keyCodes.enter || e.shiftKey || e.preventDefault()))
        }
        ,
                ...
                if (!this.el.hasAttribute("disabled")) {
                    ...
                    if (e.keyCode == t.Dictionary.keyCodes.enter && !e.shiftKey || e.keyCode == t.Dictionary.keyCodes.space)
                        if (e.keyCode == t.Dictionary.keyCodes.enter && this.active) {
                            if (!0 === this.cfReference.preventSubmitOnEnter)
                                return;
                            e.preventDefault(),
                            ...
                            if ("select" == s || "checkbox" == s) {
                                ...
                                "checkbox" == s || r.multipleChoice ? (this.active || this.isControlElementsActiveAndUserInputHidden()) && e.keyCode == t.Dictionary.keyCodes.enter ? this.submitButton.click() : (this.active || this.controlElements.active || this.isControlElementsActiveAndUserInputHidden() || (this.resetValue(),
                                this.setFocusOnInput()),
                                this.dispatchKeyChange(o, e.keyCode)) : this.dispatchKeyChange(o, e.keyCode)
                            } else
                                "group" == this._currentTag.type && this.dispatchKeyChange(o, e.keyCode)
                        } else
                            e.keyCode == t.Dictionary.keyCodes.space && document.activeElement && this.dispatchKeyChange(o, e.keyCode);
                    else
                        e.keyCode != t.Dictionary.keyCodes.shift && e.keyCode != t.Dictionary.keyCodes.tab && this.dispatchKeyChange(o, e.keyCode);
                    this.onInputChange()
                }
            }
        }
        ...
        ,
        n.prototype.windowFocus = function(t) {
            e.prototype.windowFocus.call(this, t),
            this.setFocusOnInput()
        }
        ,
        ...
        n.prototype.resetValue = function() {
            this.inputElement.value = "",
            this.inputElement.hasAttribute("rows") && this.inputElement.setAttribute("rows", "1"),
            this.onInputChange()
        }
        ,
        n.prototype.dealloc = function() {
            ...
            this.submitButton.el.removeEventListener(t.UserInputSubmitButtonEvents.CHANGE, this.onSubmitButtonChangeStateCallback, !1),
        ...
        ,
        n.prototype.getTemplate = function() {
            return this.customTemplate || '<cf-input>\n\t\t\t\t<cf-info></cf-info>\n\t\t\t\t<cf-input-control-elements>\n\t\t\t\t\t<cf-list-button direction="prev">\n\t\t\t\t\t</cf-list-button>\n\t\t\t\t\t<cf-list-button direction="next">\n\t\t\t\t\t</cf-list-button>\n\t\t\t\t\t<cf-list>\n\t\t\t\t\t</cf-list>\n\t\t\t\t</cf-input-control-elements>\n\t\t\t\t<div class="inputWrapper">\n\t\t\t\t\t<textarea type=\'input\' aria-label="Search" tabindex="0" rows="1"></textarea>\n\t\t\t\t</div>\n\t\t\t</cf-input>\n\t\t\t'
        }
        ,
        n
    }(t.UserInputElement);
...
!function(t) {
    ...
    var e = function(e) {
        function n(t) {
            var n = e.call(this, t) || this;
            return n.container = t.container,
                ...
                requestAnimationFrame(function() {
                    ...
                    try {
                        ...
                        setTimeout(function() {
                            ...
                            t.hasFlexBug() && n.scrollHeight > e.offsetHeight && (n.classList.add("scroll"),
        ...
        n.prototype.setValue = function(e) {
            ...
            if (e) {
                if (this.response = this.originalResponse = e.text,
                this.processResponseAndSetText(),
                this.responseLink && !this.isRobotResponse && this.responseLink.processResponseAndSetText(),
                e && e.controlElements && e.controlElements[0])
                    switch (e.controlElements[0].type) {
                    case "UploadFileUI":
                        this.textEl.classList.add("file-icon")
                    }
                this.isRobotResponse || this.onClickCallback || (this.onClickCallback = this.onClick.bind(this),
        ...
        n.prototype.processResponseAndSetText = function() {
            ...
            if (this.originalResponse) {
                ...
                if (this.responseLink && this.isRobotResponse && (e = e.split("{previous-answer}").join('<span style="color: orange;" class="previous-answer">' + this.responseLink.parsedResponse + '</span>')),
                this.isRobotResponse)
                    for (var s = n.list.getResponses(), r = 0; r < s.length; r++) {
                        var a = s[r];
                        a !== this && a.tag && (a.tag.id && (e = e.split("{" + a.tag.id + "}").join(a.tag.value)),
                        a.tag.name && (e = e.split("{" + a.tag.name + "}").join(a.tag.value)))
                    }
                if (-1 != e.indexOf("contains-image") && this.textEl.classList.add("contains-image"),
                this.isRobotResponse) {
                    ...
                    if (0 === l) {
                        ...
                        for (var p = this, d = 0; d < c.length; d++)
                            !function(e) {
                                setTimeout(function() {
                                    t.tryClearThinking(),
                                    t.textEl.getElementsByTagName("p")[e].classList.add("show"),
                                    t.scrollTo()
                    ...
                    this.readyTimer = setTimeout(function() {
                        ...
                        t._tag && !0 === t._tag.skipUserInput && setTimeout(function() {
                            t._tag.flowManager.nextStep(),
                            t._tag.skipUserInput = !1
                    ...
                    var g = e.indexOf("<img") > -1
                      ...
                      , b = e.match(v);
                    g && b ? (e = e.replace(b[0], ""),
                    this.textEl.innerHTML = '<p class="hasImage">' + b + "<span>" + e + "</span></p>") : this.textEl.innerHTML = "<p>" + e + "</p>";
                ...
                this.uiOptions.robot && 0 === this.uiOptions.robot.robotResponseTime ? this.addSelf() : setTimeout(function() {
                    t.addSelf()
                }, 0),
        ...
        n.prototype.scrollTo = function() {
            ...
            this.container && this.container.parentElement && this.container.parentElement.scrollHeight && (this.container.parentElement.scrollTop = t + e + this.container.parentElement.scrollHeight)
        }
        ,
        n.prototype.checkForEditMode = function() {
            this.isRobotResponse || this.el.hasAttribute("thinking") || (this.el.classList.add("can-edit"),
            this.disabled = !1)
        }
        ,
        n.prototype.tryClearThinking = function() {
            this.el.hasAttribute("thinking") && (this.textEl.innerHTML = "",
            this.el.removeAttribute("thinking"))
        }
        ,
        n.prototype.setToThinking = function() {
            (this.isRobotResponse && 0 !== this.uiOptions.robot.robotResponseTime || !this.isRobotResponse && this.cfReference.uiOptions.user.showThinking && !this._tag.skipUserInput) && (this.textEl.innerHTML = n.THINKING_MARKUP,
            this.el.classList.remove("can-edit"),
            this.el.setAttribute("thinking", "")),
            (this.cfReference.uiOptions.user.showThinking || this.cfReference.uiOptions.user.showThumb) && this.addSelf()
        }
        ,
        ...
        n.prototype.onElementCreated = function() {
            ...
            this.isRobotResponse || null != this.response ? setTimeout(function() {
                t.setValue({
                    text: t.response
                })
        ...
        ,
        n.THINKING_MARKUP = "<p class='show'><thinking><span>.</span><span>.</span><span>.</span></thinking></p>",
        n
    }(t.BasicElement);
    t.ChatResponse = e
}(cf || (cf = {}));
...
!function(t) {
    ...
    var e = function(e) {
        function n(n) {
            ...
            i.onControlElementsResizedCallback = i.onControlElementsResized.bind(i),
            i.eventTarget.addEventListener(t.ControlElementsEvents.ON_RESIZE, i.onControlElementsResizedCallback, !1),
            i.onControlElementsChangedCallback = i.onControlElementsChanged.bind(i),
            i.eventTarget.addEventListener(t.ControlElementsEvents.CHANGED, i.onControlElementsChangedCallback, !1),
            i
        }
        return __extends(n, e),
        ...
        n.prototype.onInputElementChanged = function() {
            if (this.cfReference && this.cfReference.el) {
                this.cfReference.el.offsetHeight,
                this.input.height
            }
        }
        ,
        n.prototype.onFlowUpdate = function(e) {
            ...
            this.containsTagResponse(i) && !e.detail.ignoreExistingTag ? this.onUserWantsToEditTag(i) : setTimeout(function() {
                var t = n.createResponse(!0, i, i.question);
                t.whenReady(function() {
                    n.currentUserResponse = n.createResponse(!1, i),
                    t.scrollTo()
                }),
                n.currentUserResponse && (n.currentUserResponse.setLinkToOtherReponse(t),
        ...
        n.prototype.containsTagResponse = function(t) {
            for (var e = 0; e < this.responses.length; e++) {
                ...
                if (!n.isRobotResponse && n.tag == t && !t.hasConditions())
                    return !0
            }
            return !1
        }
        ...
        n.prototype.onUserWantsToEditTag = function(t) {
            ...
            e && (this.responses.length > 2 && (this.responses[this.responses.length - 1].isRobotResponse || this.responses.pop().dealloc(),
    ...
    var e = function() {
        ...
        e.prototype.userInputSubmit = function(e) {
            ...
            var o = this.currentTag.setTagValueAndIsValid(i)
              ...
              , r = !1
              , a = function() {
                return n.currentTag.validationCallback && "function" == typeof n.currentTag.validationCallback && !s && o ? (s = !0,
                void n.currentTag.validationCallback(i, function() {
                    ...
                    t && (i.errorText = t),
                    a()
                })) : n.flowStepCallback && "function" == typeof n.flowStepCallback && !r && o ? (r = !0,
                void n.flowStepCallback(i, function() {
                    ...
                    t && (i.errorText = t),
                    a()
                })) : void (o ? (t.ConversationalForm.illustrateFlow(n, "dispatch", t.FlowEvents.USER_INPUT_UPDATE, i),
                ...
                if (s !== e)
                    for (var r = 0; r < n.length; r++) {
                        ...
                        if ("" !== l && "cf-conditional-" + l === a.key.toLowerCase()) {
                            ...
                            if (u && (this.activeConditions[l] = n,
                            ++i == n.length))
                                return !0
                        }
                    }
        ...
        e.prototype.addTags = function(t, e) {
            ...
            -1 !== e && e < this.tags.length) {
                ...
                this.tags.slice(e, this.tags.length));
        ...
        e.prototype.editTag = function(t) {
            if (this.ignoreExistingTags = !1,
            this.savedStep = this.step - 1,
            this.step = this.tags.indexOf(t),
            this.validateStepAndUpdate(),
            this.activeConditions && Object.keys(this.activeConditions).length > 0) {
                this.savedStep = -1,
        ...
        e.prototype.setTags = function(t) {
            ...
            for (var e = 0; e < this.tags.length; e++) {
                var n = this.tags[e];
                n.eventTarget = this.eventTarget,
                n.flowManager = this
            }
        ...
        e.prototype.validateStepAndUpdate = function() {
            this.maxSteps > 0 && (this.step == this.maxSteps ? (this.eventTarget.dispatchEvent(new CustomEvent(t.FlowEvents.FORM_SUBMIT,{})),
            this.cfReference.doSubmitForm()) : (this.step %= this.maxSteps,
...
!function(t) {
    var e = function() {
        function e(n) {
            ...
            "boolean" == typeof n.showProgressBar && (e.showProgressBar = n.showProgressBar),
            "boolean" == typeof n.preventSubmitOnEnter && (this.preventSubmitOnEnter = n.preventSubmitOnEnter),
            e.suppressLog || console.log("Conversational Form > version:", this.version),
            ...
            this.isDevelopment = e.illustrateAppFlow = !!document.getElementById("conversational-form-development"),
            0 == n.loadExternalStyleSheet && (this.loadExternalStyleSheet = !1),
            "string" == typeof n.theme && (this.theme = n.theme),
            isNaN(n.scrollAcceleration) || (t.ScrollController.acceleration = n.scrollAcceleration),
            ...
            if (this.formEl = n.formEl,
            this.formEl.setAttribute("cf-create-id", this.createId),
            !0 === n.hideUserInputOnNoneTextInput && (t.UserInputElement.hideUserInputOnNoneTextInput = !0),
            ...
            "" == this.formEl.getAttribute("cf-no-animation") && (e.animationsEnabled = !1),
            "boolean" == typeof n.animationsEnabled && !1 === n.animationsEnabled && (e.animationsEnabled = !1,
            this.formEl.setAttribute("cf-no-animation", "")),
            (n.preventAutoFocus || "" == this.formEl.getAttribute("cf-prevent-autofocus")) && (t.UserInputElement.preventAutoFocus = !0),
            ...
            this.tags = n.tags,
            n.microphoneInput && (n.microphoneInput.init && n.microphoneInput.input || (console.warn("Conversational Form: microphoneInput is not correctly setup", n.microphoneInput),
            n.microphoneInput = null)),
            this.microphoneInputObj = n.microphoneInput,
            this.uiOptions = t.Helpers.extendObject(t.UserInterfaceDefaultOptions, n.userInterfaceOptions || {}),
            this.init()
        }
        ...
        Object.defineProperty(e.prototype, "eventTarget", {
            get: function() {
                return this._eventTarget || (this._eventTarget = new t.EventDispatcher(this)),
                this._eventTarget
            },
            enumerable: !0,
            configurable: !0
        ...
        e.prototype.init = function() {
            ...
            if (this.isDevelopment && (this.cdnPath = "../build/",
            ...
            if (-1 == ["fixed", "absolute", "relative"].indexOf(window.getComputedStyle(this.context).getPropertyValue("position").toLowerCase()) && (this.context.style.position = "relative"),
            ...
            return e.suppressLog || this.tags && 0 != this.tags.length || console.warn("Conversational Form: No tags found or registered."),
        ...
        e.prototype.updateDictionaryValue = function(e, n, i) {
            ...
            -1 != ["robot-image", "user-image"].indexOf(e) && this.chatList.updateThumbnail("robot-image" == e, i)
        }
        ,
        ...
        e.prototype.setupTagGroups = function(e) {
            for (var n = [], i = 0; i < e.length; i++) {
                var o = e[i];
                "radio" != o.type && "checkbox" != o.type || (n[o.name] || (n[o.name] = []),
                n[o.name].push(o))
            }
            if (Object.keys(n).length > 0)
                for (var s in n)
                    if (n[s].length > 0) {
                        ...
                        r && "fieldset" !== r.tagName.toLowerCase() && (r = r.parentNode,
                        function(t) {
        ...
        e.prototype.setupUI = function() {
            ...
            e.animationsEnabled && this.el.classList.add("conversational-form--enable-animation"),
            this.preventAutoAppend || this.context.appendChild(this.el),
            this.el.style.visibility = "hidden";
            var n = document.createElement("div");
            if (n.className = "conversational-form-inner",
            ...
            this.eventTarget.addEventListener(t.ChatResponseEvents.USER_ANSWER_CLICKED, this.onUserAnswerClickedCallback, !1),
        ...
        e.prototype.addBrowserTypes = function(t) {
            navigator.userAgent.indexOf("Firefox") > -1 && t.classList.add("browser-firefox"),
        ...
        e.prototype.addTags = function(e, n, i) {
                ...
                if ("fieldset" === r.tag)
                    for (var a = t.TagsParser.parseGroupTag(r), l = 0; l < a.children.length; l++) {
                        ...
                        if (t.Tag.isTagValid(c)) {
                            ...
                            u.name || (u.name = "tag-ref-" + l.toString()),
                            o.push(u)
                        }
                    }
                else {
            ...
            this.tags = this.flowManager.addTags(o, n ? this.flowManager.getStep() + 1 : i)
        }
        ,
        ...
        e.prototype.remove = function() {
            ...
            this.onUserAnswerClickedCallback && (this.eventTarget.removeEventListener(t.ChatResponseEvents.USER_ANSWER_CLICKED, this.onUserAnswerClickedCallback, !1),
        ...
        e.illustrateFlow = function(t, n, i, o) {
            ...
            e.illustrateAppFlow) {
                ...
                e.suppressLog || console.log("%c** event flow: %c" + i + "%c flow type: %c" + n + "%c from: %c" + t.constructor.name, "font-weight: 900;", s, "font-weight: 400;", s, "font-weight: 400;", s),
